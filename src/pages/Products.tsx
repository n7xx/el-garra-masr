...
const Products = () => {
  ...
  const getCartQuantity = (productId: string) => items.find((i) => i.productId === productId)?.quantity || 0;
...
const ProductCard = ({ product, cartQty, addItem, updateQuantity }: ProductCardProps) => {
  const handleAdd = () => {
    addItem({
